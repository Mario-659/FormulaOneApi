...
INSERT INTO accident (name, description) VALUES ('Appeal', 'An action that a team takes on its drivers'' behalf if it feels that they have been unfairly penalised by the race officials.');
INSERT INTO accident (name, description) VALUES ('107% rule', 'During the first phase of qualifying, any driver who fails to set a lap within 107 percent of the fastest Q1 time will not be allowed to start the race. However, in exceptional circumstances, which could include a driver setting a suitable time during practice, the stewards may permit the car to start.');
INSERT INTO accident (name, description) VALUES ('Blistering', 'The consequence of a tyre, or part of a tyre, overheating. Excess heat can cause rubber to soften and break away in chunks from the body of the tyre. Blistering can be caused by the selection of an inappropriate tyre compound (for example, one that is too soft for circuit conditions), too high tyre pressure, or an improperly set up car. The consequence of a tyre, or part of a tyre, overheating. Excess heat can cause rubber to soften and break away in chunks from the body of the tyre. Blistering can be caused by the selection of an inappropriate tyre compound (for example, one that is too soft for circuit conditions), too high tyre pressure, or an improperly set up car.');
INSERT INTO accident (name, description) VALUES ('Bottoming', 'When a car''s chassis hits the track surface as it runs through a sharp compression and reaches the bottom of its suspension travel.');
INSERT INTO accident (name, description) VALUES ('Degradation', 'A term used to describe the process by which a tyre loses performance or grip. Different from tyre wear which concerns the process by which the tread is worn away.');
INSERT INTO accident (name, description) VALUES ('Downforce', 'The aerodynamic force that is applied in a downwards direction as a car travels forwards. This is harnessed to improve a car''s traction and its handling through corners.');
INSERT INTO accident (name, description) VALUES ('Drag', 'The aerodynamic resistance experienced as a car travels forwards.');
INSERT INTO accident (name, description) VALUES ('Drive-through penalty', 'One of two penalties that can be handed out at the discretion of the Stewards whilst the race is still running. Drivers must enter the pit lane, drive through it complying with the speed limit, and re-join the race without stopping.');
INSERT INTO accident (name, description) VALUES ('DRS', 'Also known as adjustable rear wings, DRS (Drag Reduction System) rear wings allow the driver to adjust the wing between two pre-determined settings from the cockpit. The system''s availability is electronically governed - it can be used at any time in practice and qualifying (unless a driver is on wet-weather tyres), but during the race can only be activated when a driver is less than one second behind another car at pre-determined points on the track. The system is then deactivated once the driver brakes. In combination with KERS, it is designed to boost overtaking. Also like KERS, it isn''t compulsory.');
INSERT INTO accident (name, description) VALUES ('ECU', 'Short for Electronic Control Unit, a standard unit that controls the electrical systems on all F1 cars including the engine and gearbox.');
INSERT INTO accident (name, description) VALUES ('Energy Store', 'The Energy Store (sometimes abbreviated to ES) is an integral part of an F1 car''s powertrain and ERS. Located in the fuel cell and weighing between 20-25kg, the Energy Store usually consists of lithium ion batteries. The Energy Store can store (or return to the drivetrain) 4MJ of energy per lap, although MGU-K (see ERS) may only charge the Energy Store with 2MJ per lap.');
INSERT INTO accident (name, description) VALUES ('ERS', 'Energy Recovery Systems, or ERS for short, consist of Motor Generator Units that harness waste heat energy (from the turbocharger) and waste kinetic energy (from the braking system). This energy is then stored and subsequently used to propel the car. An F1 car has two ERS: MGU-K (which stands for Motor Generator Unit - Kinetic) and MGU-H (which stands for Motor Generator Unit - Heat). These systems are complemented by an Energy Store (ES) and control electronics. ERS is capable of providing 120kw of power (approximately 160bhp) for approximately 33 seconds per lap.');
INSERT INTO accident (name, description) VALUES ('G-Force', 'A physical force equivalent to one unit of gravity that is multiplied during rapid changes of direction or velocity. Drivers experience severe G-forces as they corner, accelerate and brake.');
INSERT INTO accident (name, description) VALUES ('Graining', 'When a car slides, it can cause little bits or rubber (''grains'') to break away from the tyre''s grooves. These then stick to the tread of the tyre, effectively separating the tyre from the track surface very slightly. For the driver, the effect is like driving on ball bearings. Careful driving can clear the graining within a few laps, but will obviously have an effect on the driver''s pace. Driving style, track conditions, car set-up, fuel load and the tyre itself all play a role in graining. In essence, the more the tyre moves about on the track surface (ie slides), the more likely graining is.');
INSERT INTO accident (name, description) VALUES ('Grip', 'The amount of traction a car has at any given point, affecting how easy it is for the driver to keep control through corners.');
INSERT INTO accident (name, description) VALUES ('Lock-up', 'The term used to describe a driver braking sharply and ''locking'' one or more tyres whilst the others continue rotating. Tyre smoke and flat spots are common side effects.');
INSERT INTO accident (name, description) VALUES ('Oversteer', 'When a car''s rear end doesn''t want to go around a corner and tries to overtake the front end as the driver turns in towards the apex. This often requires opposite-lock to correct, whereby the driver turns the front wheels into the skid.');
